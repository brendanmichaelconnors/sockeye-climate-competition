## Exploratory graphics and summaries for sockeye and covariate data
...
cor.stock <- plyr::ddply(sock, .(Stock.ID), summarize,
                         ...
                         late_sst = cor(lnRS, late_sst, use = "pairwise.complete.obs"),
                         np_pinks_geo = cor(lnRS, np_pinks_geo, use = "pairwise.complete.obs"),
                         np_pinks_sec = cor(lnRS, np_pinks_sec, use = "pairwise.complete.obs"),
                         late_mld_winter = cor(lnRS, late_mld_winter, use = "pairwise.complete.obs"),
                         late_mld_summer = cor(lnRS, late_mld_summer, use = "pairwise.complete.obs"))
...
pdf("./figures/sock-explore/sst_late_index.pdf", width = 19, height = 9)
g <- xyplot(late_sst ~ BY | Stock, data = sock,
            type = "l",
            par.settings = theme.mjm(),
            xlab = "Brood year",
            ylab = "Late SST index",
            main = "Late (1st ocean winter) SST index by stock",
            panel = function(x, y, ...) {
                panel.abline(h = 0, col = "grey50", lty = 2)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.xyplot(x, y, ...)
...
## MLD indices ---------------------------------------------
pdf("./figures/sock-explore/mld_late_winter_index.pdf", width = 19, height = 9)
g <- xyplot(late_mld_winter ~ BY | Stock, data = sock,
            type = "l",
            par.settings = theme.mjm(),
            xlab = "Brood year",
            ylab = "Late winter MLD index",
            main = "Late winter MLD index by stock",
            panel = function(x, y, ...) {
                panel.abline(h = 0, col = "grey50", lty = 2)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.xyplot(x, y, ...)
...
pdf("./figures/sock-explore/mld_late_summer_index.pdf", width = 19, height = 9)
g <- xyplot(late_mld_summer ~ BY | Stock, data = sock,
            type = "l",
            par.settings = theme.mjm(),
            xlab = "Brood year",
            ylab = "Late summer MLD index",
            main = "Late summer MLD index by stock",
            panel = function(x, y, ...) {
                panel.abline(h = 0, col = "grey50", lty = 2)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.xyplot(x, y, ...)
...
pdf("./figures/sock-explore/pink_index_geographic.pdf", width = 19, height = 9)
g <- xyplot(np_pinks_geo ~ BY | Stock, data = sock,
            type = "l",
            xlab = "Brood year",
            ylab = "Geographic pink abundance index",
            main = "Geographic pink abundance index by stock",
            par.settings = theme.mjm(),
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
...
pdf("./figures/sock-explore/comparison_sst_early_late.pdf", width = 19, height = 9)
g <- xyplot(late_sst_stnd ~ early_sst_stnd | Stock, data = sock,
            type = "p", col = 1, cex = 0.5,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            xlab = "Early SST index",
            ylab = "Late SST index",
            main = "Comparison of early and late SST indices",
            par.settings = theme.mjm(),
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
...
pdf("./figures/sock-explore/comparison_pink_second_geographic.pdf", width = 19, height = 9)
g <- xyplot(np_pinks_sec_stnd ~ np_pinks_geo_stnd | Stock, data = sock,
            type = "p", col = 1, cex = 0.5,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            ylab = "Second year pink abundance index",
            xlab = "Geographic pink abundance index",
            main = "Comparison of pink second year and geographic pink indices",
            par.settings = theme.mjm(),
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
...
pdf("./figures/sock-explore/comparison_pink_second_sst_late.pdf", width = 19, height = 9)
g <- xyplot(np_pinks_sec_stnd ~ late_sst_stnd | Stock, data = sock,
            type = "p", col = 1, cex = 0.5,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            par.settings = theme.mjm(),
            xlab = "Late SST index",
            ylab = "Second year pink abundance index",
            main = "Comparison of pink second and late SST indices",
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.text(-2.75, 2.75,
...
pdf("./figures/sock-explore/comparison_late_mld_winter_summer.pdf", width = 19, height = 9)
g <- xyplot(late_mld_summer_stnd ~ late_mld_winter_stnd | Stock, data = sock,
            type = "p", col = 1, cex = 0.5,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            par.settings = theme.mjm(),
            xlab = "Winter MLD late index",
            ylab = "Summer MLD late index",
            main = "Comparison of Winter and Summer MLD late indices",
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.text(-2.75, 2.75,
...
pdf("./figures/sock-explore/comparison_sst_late_mld_winter_late.pdf", width = 19, height = 9)
g <- xyplot(late_mld_winter_stnd ~ late_sst_stnd | Stock, data = sock,
            type = "p", col = 1, cex = 0.5,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            par.settings = theme.mjm(),
            xlab = "Late SST index",
            ylab = "Winter late MLD index",
            main = "Comparison of winter MLD late and late SST indices",
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.text(-2.75, 2.75,
...
pdf("./figures/sock-explore/comparison_sst_late_mld_summer_late.pdf", width = 19, height = 9)
g <- xyplot(late_mld_summer_stnd ~ late_sst_stnd | Stock, data = sock,
            type = "p", col = 1, cex = 0.5,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            par.settings = theme.mjm(),
            xlab = "Late SST index",
            ylab = "Summer late MLD index",
            main = "Comparison of summer MLD late and late SST indices",
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
                panel.text(-2.75, 2.75,
...
pdf("./figures/sock-explore/comparison_pink_total_hatchry.pdf", width = 19, height = 9)
g <- xyplot(np_pinks_hatch_sec_stnd ~ np_pinks_sec_stnd | Stock, data = sock,
            xlim = c(-3.25, 3.25),
            ylim = c(-3.25, 3.25),
            type = "p", col = 1, cex = 0.5,
            xlab = "Total pink abundance index",
            ylab = "Hatchery pink abundance index",
            main = "Comparison of total and hatchery pink indices",
            par.settings = theme.mjm(),
            panel = function(x, y, ...) {
                panel.xyplot(x, y, ...)
                panel.loess(x, y, col = "red2", lwd = 2)
